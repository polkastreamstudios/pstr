# Project Description
[Polkastream Studios (PDAO)](https://polkastream.org/) is building an integrated and intelligently monetized platform for the over-the-top (OTT) streaming market. On the [Polkastream](https://polkastream.app/) platform, users can stream music, podcasts, movies, and TV shows. Creators can also generate music and videos using AI. In return, streamers and creators are rewarded with the PSTR token, which incorporates holder-redistribution and token-burning mechanisms.


# Tokenomics
PSTR is minted on [Binance Smart Chain (BSC)](https://bscscan.com/address/0x3cdd71d99cb393928b74d549d4cb0a6ffe0a60a8) with an initial maximum supply of one billion (1,000,000,000) tokens. PSTR is built with an Automated Rewards Farming (ARF) system that includes:
...
As an added token security and stability feature, PSTR has a limit of one million (1,000,000) tokens per transaction. This anti-slippage transaction limit is updateable with Polkastream Decentralized Autonomous Organization (PDAO) proposals made by the community.
...
- Creators receive instant rewards for publishing AI-generated music and video content directly on their channel.
- PSTR can be staked in the various entertainment programs for an APY interest.
- As the governance token of the Polkastream OTT streaming platform, users can use PSTR to create proposals and vote on existing ones to bring any desired changes to the platform’s offerings.

# Smart Contract Address
```
0x3cdd71d99cb393928b74d549d4cb0a6ffe0a60a8
```
...
# Disclaimers
- There is only one PSTR smart contract on BSC and no other blockchains. Here it is again: [bscscan.com/address/0x3cdd71d99cb393928b74d549d4cb0a6ffe0a60a8](https://bscscan.com/address/0x3cdd71d99cb393928b74d549d4cb0a6ffe0a60a8). Please always confirm it before making any investment decisions.
...
# Questions?
Connect with us on 𝕏 at [x.com/polkastream](https://x.com/polkastream), or join the PDAO Discord server at [discord.gg/0xpdao](https://discord.gg/0xpdao), and the core and admin teams will be happy to answer your questions.
